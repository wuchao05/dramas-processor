...
└── 9.3导出/          # 新创建的日期目录
    ├── 短剧1/
    │   ├── 9.3-短剧1-<material_code>-01.mp4
    │   └── 9.3-短剧1-<material_code>-02.mp4
    ├── 短剧2/
    │   ├── 9.3-短剧2-<material_code>-01.mp4
    │   └── 9.3-短剧2-<material_code>-02.mp4
    └── ...
```
...
3. **文件命名**：文件名中的日期前缀与目录组织保持一致；`<material_code>` 可通过 `material_code` 配置项自定义（默认 `xl`）
